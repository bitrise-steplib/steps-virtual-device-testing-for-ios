...
type IosDevice struct {
	// IosModelId: The id of the iOS device to be used.
	// Use the EnvironmentDiscoveryService to get supported
	// options.
	// Required
	IosModelId string `json:"iosModelId,omitempty"`

	// IosVersionId: The id of the iOS major software version to be
	// used.
	// Use the EnvironmentDiscoveryService to get supported
	// options.
	// Required
	...
	// currently
	// supported). Use the EnvironmentDiscoveryService to get supported
	// options
	// (not yet implemented).
	// Required
	Locale string `json:"locale,omitempty"`

	// Orientation: How the device is oriented during the test (only
	// "portrait" is currently
	// supported). Use the EnvironmentDiscoveryService to get supported
	// options.
	// (not yet implemented).
	// Required
...
type IosVersion struct {
	...
	// MajorVersion: A integer representing the major iOS version.
	// Examples: "8", "9"
	// @OutputOnly
	MajorVersion int64 `json:"majorVersion,omitempty"`

	// MinorVersion: A integer representing the minor iOS version.
	// Examples: "1", "2"
	// @OutputOnly
...
type IosXcTest struct {
	// TestsZip: The .zip containing the .xctestrun file and the contents of
	// the
	...
	// in the tests zip.
	// Because the .xctestrun file contains environment variables along with
	// test
	// methods to run and/or ignore, this can be useful for sharding
	// tests.
	// Optional, default is taken from the tests zip.
